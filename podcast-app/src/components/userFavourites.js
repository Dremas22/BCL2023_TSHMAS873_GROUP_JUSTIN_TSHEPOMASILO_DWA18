...
// import SaveFavorites from './supadatabase'
...
//   const [save, setSaveFavorites] = React.useState([]);
...
import React from 'react';
import saveFavoriteToDatabase from './supadatabase'
...
const User = () => {
  ...
  return (
    <div className='epi-favor'>
      ...
      <div className='auth'>
        <button onClick={handleLoggingToSupabase}>Check Favorites</button>
      </div>
